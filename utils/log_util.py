...
class CustomLog:
    ...
    def log_with_location(logger, level, message, location_info):
        ...
        logger.log(CustomLog.level_relations.get(level), msg=f"{location_info} - {message}")

    def my_log(self, msg, location_info, level="error", when="MIDNIGHT", back_count=7):
        """
